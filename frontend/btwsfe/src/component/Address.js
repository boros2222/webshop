...
function Address({address, addressName, register, errors, disabled = false, required = false}) {
    return (
        <div className="row primary-color">
            ...
            <p className={"col-12 col-lg-6 mt-3" + (required ? " required" : "")}>Város:</p>
            <input className="col-12 col-lg-6 mt-3" type="text" name={`${addressName}.city`} disabled={disabled}
            ...
            <p className={"col-12 col-lg-6 mt-3" + (required ? " required" : "")}>Utca:</p>
            <input className="col-12 col-lg-6 mt-3" type="text" name={`${addressName}.street`} disabled={disabled}
            ...
            <p className={"col-12 col-lg-6 mt-3" + (required ? " required" : "")}>Házszám:</p>
            <input className="col-12 col-lg-6 mt-3" type="text" name={`${addressName}.houseNumber`} disabled={disabled}
