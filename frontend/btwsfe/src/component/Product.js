    ...
    return (
        <div className="product-card">
            <div className="row">
                ...
                <div className="col-12 col-lg-7 product-text">
                    ...
                    <div style={{marginTop: "1em"}}>
                        Kategória:
                        <Link className="space-left" to={`/category/${product.category.id}`}>{product.category.name}</Link>
                    </div>
                </div>
                <div className="col-12 col-lg-2 product-price text-right">
